    ...
    <footer className="footer">
      ...
      <ul className="social-icon">
        <li className="social-icon__item">
          <a className="social-icon__link" target="__blank" href="https://github.com/akshayp1754">
          <box-icon name='github' type='logo' ></box-icon>
          </a>
        </li>
        <li className="social-icon__item">
          <a className="social-icon__link" target="__blank" href="https://twitter.com/akshayp1754">
        ...
        <li className="social-icon__item">
          <a className="social-icon__link" target="__blank" href="https://www.instagram.com/akshaypawar1754">
