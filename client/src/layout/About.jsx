    ...
    <div className=" min-h-screen py-8 dark:text:gray-50 max-sm:w-full">
      <div className="container mx-auto p-8  dark:text:gray-50 mt-10">
        ...
        <p className="dark:text:gray-50 text-gray-900 dark:text-gray-50 mb-8">
          Welcome to my Pinterest-inspired website! <br/>My name is Akshay Pawar, and I developed this website as a way to learn more about MERN stack technology. MERN stack refers to the combination of MongoDB, Express.js, React, and Node.js, which are all used in the development of this project.
